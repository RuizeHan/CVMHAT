function [tracks,trackFrame] = run_GOG(detOrig,minFrame,maxFrame,param,im_preread,weight)
...
if ~isempty(dres.x)
    dres = build_graph_new(dres,param.overlap_threshold,param.color_threshold,param.cen_threshold,im_preread,weight);
